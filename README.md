...
See [`CHANGELOG.md`](CHANGELOG.md). For a detailed tour of the latest release
(workspace integration, task context attachments, project categories) see
[`WHATS_NEW.md`](WHATS_NEW.md). Highlights:

- **2.20.0** -- Workspace integration: team/skills/wiki/docs in the sidebar, attach workspace files as task context, project categories, project hiding, resizable sidebar. Details in [`WHATS_NEW.md`](WHATS_NEW.md).
