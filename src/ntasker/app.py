...
def build_js_strings() -> dict[str, str]:
    ...
    * adding a new key is one line in one place.
    ...
    strings = {
        ...
        "project_summary_placeholder": _("One paragraph: what this project is and what belongs to it"),
        "project_summary_regenerate": _("Regenerate"),
        "summary_failed": _("Could not generate the summary"),
        ...
        "claude_resume_open": _(
            "Continue this task's last session -- the run button next to it "
            "would start over with a fresh prompt."
        ),
...
def index(request: Request) -> HTMLResponse:
    ...
    response = templates.TemplateResponse(
        ...
        context={
            ...
            "triage_enabled": get_triage_enabled(),
            "links": LINKS,
            **_page_plugins(),
        },
    )
